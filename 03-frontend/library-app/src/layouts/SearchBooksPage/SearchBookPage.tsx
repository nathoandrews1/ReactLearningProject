    ...
    useEffect(() => {
        const fetchBooks = async () => {
            ...
            if (searchUrl === '') {
                ...
                let searchWithpageNumber = searchUrl.replace('<pageNumber>', (currentPage - 1).toString());
                url = baseUrl + searchWithpageNumber;
            }
                    ...
                    <div className='col-6'>
                        <div className='d-flex'>
                            <input className='form-control me-2' type='search' placeholder='Search' aria-label='Search'
                                onChange={e => setSearch(e.target.value)} onKeyDown={e => e.key === 'Enter' && searchHandleChange()}/>
                    ...
                    {totalAmountOfBooks > 0 ?
                        ...
                        <>
                            <div className='m-5'>
                                ...
                                <a type="button" className='btn main-color btn-md me-md-2 px-4 fw-bold text-white'>Library Services</a>
                            </div>
                        </>
                    }
